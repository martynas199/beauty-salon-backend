...
const PaymentSchema = new mongoose.Schema({
  mode: { type: String, enum: ["pay_now","deposit","pay_in_salon"], index: true },
  provider: { type: String, enum: ["stripe","cash","pos"], default: "stripe" },
  status: { type: String, enum: ["succeeded","requires_action","refunded","partial_refunded","unpaid"], default: "unpaid" },
  sessionId: String,
